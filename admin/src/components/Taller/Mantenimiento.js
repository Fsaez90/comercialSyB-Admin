...
function Mantenimiento({clock, date, render, setRender}) {
...
//const sortedList = lista.slice().sort((a, b) => a.id - b.id);
  ...
  if (lista.length !== 0) {
    return (
      <div>
        ...
        <div className='frame'>
          <h1 className='title-component'>Ordenes de trabajo en espera de mantenimiento: </h1>
